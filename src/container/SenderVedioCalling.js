...
const SenderVedioCalling = ({ route, navigation }) => {
    const { params } = route
    ...
    return (
        <Fragment>
            {img ? (
                <ImageBackground source={{ uri: img }} style={styles.BackgroundImg} resizeMode="cover" imageStyle={{ opacity: 0.5 }} >
                    <View style={{
                        ...
                        <Text style={styles.TextRinning}>Rinning....</Text>
                    </View>
...
const styles = StyleSheet.create({
    ...
    FabEndCalling: {
        backgroundColor: '#F91212', position: 'absolute',
    },
    FabVideo: {
        backgroundColor: 'rgb(11, 89, 173)', position: 'absolute',
    },
    FabMic: {
        backgroundColor: 'rgb(11, 89, 173)', position: 'absolute',
...
export default SenderVedioCalling;